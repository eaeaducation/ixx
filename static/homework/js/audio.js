document.addEventListener('DOMContentLoaded', function() {
    // 设置音频文件名显示宽度
    var element = document.querySelector('.audio-left');
    var maxWidth = window.getComputedStyle(element, null).width;
    // document.querySelector('.audio-left p').style.maxWidth = maxWidth;
...
function initAudioEvent() {
    ...
    audioPlayer.addEventListener('click', function() {
        ...
        if (audio.paused) {
            // 开始播放当前点击的音频
            audio.play();
            audioPlayer.src = '/static/homework/images/pause.png';
        } else {
            audio.pause();
            audioPlayer.src = '/static/homework/images/play.png';
        }
    }, false);
...
function audioEnded() {
    ...
    document.getElementById('progressDot').style.left = -5;
