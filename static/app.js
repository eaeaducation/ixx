...
require.config({
    ...
    paths: {
        ...
        //fullcalendar日历插件
        'fullcalendar': ['plugs/fullcalendar/fullcalendar.min'],
        'jqui': ['plugs/fullcalendar/jquery-ui.min'],
        'lang-all': ['plugs/fullcalendar/lang-all'],
        'moment': ['plugs/fullcalendar/moment.min'],
        'jquery.raty': ['plugs/jquery-raty/jquery.raty'],
        'survey': ['plugs/survey/js/survey'],
        'echarts': ['plugs/echarts/echarts.min'],
        'echarts.roma': ['plugs/echarts/theme/roma.min'],
        'echarts.dark': ['plugs/echarts/theme/dark.min'],
    },
    shim: {
        // open-source
        ...
        'jquery.raty': {deps: ['css!' + baseRoot + 'plugs/jquery-raty/jquery.raty.css']},
        'survey': {deps: ['jquery', 'css!' + baseRoot + 'plugs/survey/css/survey.css']},
        // bootstrap
