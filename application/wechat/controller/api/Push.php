    ...
    protected function keys($rule, $isLastReply = false)
    {
        ...
        switch ($info['type']) {
            ...
            case 'music':
                ...
                $data = ['Title' => $info['music_title'], 'Description' => $info['music_desc'], 'MusicUrl' => $info['music_url'], 'HQMusicUrl' => $info['music_url'], 'ThumbMediaId' => $media_id];
            ...
            case 'video':
                ...
                $data = ['MediaId' => $media_id, 'Title' => $info['video_title'], 'Tescription' => $info['video_desc']];
