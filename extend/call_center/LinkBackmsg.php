...
class LinkBackmsg
{
    public static $messages = [
        ...
        'BackMsg_10' => '切换队列状态失败!',
        'BackMsg_11' => '坐席组ID不存在[坐席组ID]',
        'BackMsg_12' => '不存在此座席',
        'BackMsg_13' => '变量type错误',
        'BackMsg_14' => '切换队列状态成功!',
        'BackMsg_15' => '帐号不存在',
        'BackMsg_16' => '呼叫失败,坐席未签入',
        'BackMsg_17' => '呼叫失败,坐席当前状态[状态]。若状态为空，参考BackMsg_16',
        ...
        'BackMsg_61' => '结束话后成功',
        'BackMsg_62' => '工作模式切换成功',
        'BackMsg_63' => '用usertype=account方式调用接口,但帐号不存在或密码错误',
        'BackMsg_64' => '通话channel不存在。',
        'BackMsg_65' => '该坐席不是坐席组长',
        'BackMsg_66' => '坐席已经处于暂停状态',
        'BackMsg_67' => '外拨营销任ID错误',
        'BackMsg_68' => '不是坐席组长',
        'BackMsg_69' => '预拨号数据导入完毕',
        'BackMsg_70' => 'modeltype或model_id参数定义错误',
        'BackMsg_71' => 'context参数不能为空',
        'BackMsg_72' => 'source参数定义错误',
        'BackMsg_73' => '外呼营销任务不存在',
        'BackMsg_74' => '文件标题头与数据表结构不符.',
        'BackMsg_75' => 'context参数错误,无法构建SQL.',
        ...
        'BackMsg_98' => '发送DTMF操作失败',
        'BackMsg_99' => '发送DTMF操作成功',
        'BackMsg_100' => '内核连接失败',
        'BackMsg_101' => 'varname只允许大写字母,数字,-,_,并且只能以大写字母或数字开头',
        'BackMsg_102' => '设置随路数据成功',
        'BackMsg_103' => '设置随路数据失败',
        'BackMsg_104' => '咨询中不允许转IVR操作',
        'BackMsg_105' => '会议中不允许释放转',
        'BackMsg_106' => '主IVR不存在,请检查ivrexten参数正确性',
        'BackMsg_107' => 'IVR流程错误,请检查ivrflow参数正确性',
        'BackMsg_108' => '坐席转IVR操作成功',
        'BackMsg_109' => '坐席转IVR操作失败',
        'BackMsg_110' => '分机不存在',
        ...
        'BackMsg_117' => 'App请求拨号失败',
        'BackMsg_118' => '坐席未设置分机信息',
        'BackMsg_119' => '无法获取分机注册状态',
        'BackMsg_120' => '[ip]已向话机发送请求[话机ip地址]',
        'BackMsg_121' => '此分机号码已被其它签入坐席占用',
        'BackMsg_122' => '[type]不支持此yealink话机型号[话机型号]',
